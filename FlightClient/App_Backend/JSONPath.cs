            ...
            try
            {
                ...
                //if (JSONPathCmd.Contains("[?(@"))
                {
                    ...
                    try
                    {
                        ...
                        {
                            res = Newtonsoft.Json.JsonConvert.SerializeObject(json.SelectTokens(JSONPathCmd));
                        }
                    }
                    catch {
                ...
                //    var values = context.SelectNodes(json, JSONPathCmd).Select(node => node.Value);


                //    res = Newtonsoft.Json.JsonConvert.SerializeObject(values);
